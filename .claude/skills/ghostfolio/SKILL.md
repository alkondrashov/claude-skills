...
- **Stocks and Shares ISA (Vanguard)**: `be08db84-cbaf-4e99-ac40-87ce96992ec7`
- **Savings (1.23% AER)** (Investec Instant Access savings): `13993c80-84eb-4d6d-b42f-778410f5d92d` — currency: USD, platformId: `747b9016-8ba1-4d13-8255-aec49a468ead`
...
3. **Create the INTEREST activity**:
   - `symbol`: use the account's interest activity name (see Known Accounts above — e.g. `"GROSS INTEREST"` for HSBC accounts, `"Interest paid"` for Savings)
